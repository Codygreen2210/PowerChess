...
import type { Board, Color, Effect, GameOver, Move, Piece, PieceType } from "../../lib/engine/types";
import type { Card, CardKey } from "../../lib/engine/cards";
import { CARDS, CARD_KEYS, TIERS, HAND_LIMIT, drawFromTier } from "../../lib/engine/cards";
import { PIECE_VALUE } from "../../lib/engine/constants";
import { makeInitialBoard, cuid, inBounds } from "../../lib/engine/board";
import { applyMove, isInCheck } from "../../lib/engine/moves";
import { getEffectiveLegalMoves, hasAnyLegalMove } from "../../lib/engine/legal";

// =====================================================================
// LOCAL TYPES (UI interaction state)
// =====================================================================
